      ...
      <section className="m-7 mt-32 xl:mt-52 2xl:ml-0">
        <div className="container-lg about-hero py-6">
          <div className="privacy-policy-row mb-12 items-center justify-center">
            <div className="style-right-border mx-2 w-full">
              ...
              <p>
                ...
                <Link
                  ...
                  className="text-[1rem] text-primary-green underline md:text-[1.2rem]"
                  target="_blank"
                >
                  https://smashcode.dev/
                </Link>
                ...
                is collected and recorded by Smash Code and how we use it.
              </p>
              ...
              <p>
                ...
                information that they shared and/or collect in Smash Code. This
                policy is not applicable to any information collected offline or
                via channels other than this website.
              </p>
            </div>
            <div className="style-left-border w-full">
              <div className="mx-3">
                <h2 className="privacy-policy-heading py-4">Consent</h2>
                ...
                <h2 className="privacy-policy-heading py-4">
            ...
            <div className="style-right-border w-full">
              <div className="mx-3">
                <h2 className="privacy-policy-heading py-4">
                ...
                <h2 className="privacy-policy-heading py-4">Log Files</h2>

                <p>
                  Smash Code follows a standard procedure of using log files.
            ...
            <div className="style-left-border w-full">
              <div className="mx-3">
                ...
                <p>
                  ...
                  of the advertising partners of Smash Code.
                </p>

                <p>
                  Third-party ad servers or ad networks uses technologies like
                  cookies, JavaScript, or Web Beacons that are used in their
                  respective advertisements and links that appear on Smash Code,
                ...
                <p>
                  Note that Smash Code has no access to or control over these
                ...
                <p>
                  Smash Code&apos;s Privacy Policy does not apply to other
            ...
            <div className="style-left-border w-full">
              <div className="mx-3">
                ...
                <p>
                  Smash Code does not knowingly collect any Personal
            ...
            <div className="style-right-border w-full">
              <div className="mx-3">
                <h2 className="privacy-policy-heading py-4">Contact Us</h2>
